...
" ステータスラインと境界線
hi StatusLine guifg=#FFFFFF guibg=#339966 gui=NONE ctermfg=231 ctermbg=110 cterm=NONE
hi StatusLineNC guifg=#ffffff guibg=#99CC99 gui=NONE ctermfg=231 ctermbg=153 cterm=NONE
hi VertSplit guifg=#99CC99 guibg=#99CC99 gui=NONE ctermfg=153 ctermbg=153 cterm=NONE
