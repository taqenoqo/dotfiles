...
set ruler
set runtimepath=~/.vim,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,~/.dein/repos/github.com/Shougo/vimproc.vim,~/.dein/.cache/.vimrc/.dein,/usr/share/vim/vim90,~/.dein/.cache/.vimrc/.dein/after,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/dein.vim
set scrolloff=5
set shiftwidth=4
...
set undofile
set updatetime=100
set viminfo='100,<50,s10,h,n/home/okamoto-n/.vimcache/viminfo
set wildmenu
